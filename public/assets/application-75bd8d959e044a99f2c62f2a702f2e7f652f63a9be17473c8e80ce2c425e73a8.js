...
function redirectToSkinFood(){
  window.location.pathname = "/skin_food"
};
...
function redirectToShop(){
  window.location = "http://clean-beauty-co.myshopify.com/";
}

$(document).ready(function(){
  console.log('hello');

  $('.product-click-dropdown').on('click', redirectToShop);

  $('.homepage-email-input').text("Let's get connected")
  // HOMEPAGE FUNCTIONS ***************
  ...
  if($('.recipe-image img').height() > $('.recipe-image img').width()){
    $('.recipe-image img').height($('.recipe-image img').width()) ;
  };

  $('a').hover(function(){
    if(window.location.pathname == "/" || window.location.pathname.indexOf('contacts') > -1){
      $(this).addClass('cloud-cursor');
    } else if(window.location.pathname == "/abouts" || window.location.pathname == "/events"){
      $(this).addClass('apple-cursor');
    } else if(window.location.pathname.indexOf('press') > -1){
      $(this).addClass('cloud-cursor');
    } else if(window.location.pathname.indexOf('blog_entries') > -1){
      $(this).addClass('star-cursor');
    } else if(window.location.pathname == "/contacts/new"){
      $(this).addClass('strawb-cursor');
    } else if(window.location.pathname == "/diy_beauty"){
      $(this).addClass('carrot-cursor');
    } else if(window.location.pathname.indexOf('recipes') > -1 || window.location.pathname == "/diy_beauty" || window.location.pathname == "/skin_food"){
      $(this).addClass('plumb-cursor');
    }
  });
  ...
  $('.skin-food-link').on('click', redirectToSkinFood);
  // $('.all-recipes-link').on('click', redirectToAllRecipes);
  ...
  $('.indiv_press_entry img').hover(function(){
    $(this).animate({opacity: 0.5}, 50)
  })
  $('.indiv_press_entry img').mouseleave(function(){
    $(this).animate({opacity:1}, 50);
  });
